...
if __name__ == "__main__":
    env_config = ServiceEndpoints(
        kafka_bootstrap_servers="_KAFKA_BROKERS:9092",
        tidb_host="_TIDB_HOST_IP",
        tidb_port=4000,
        tidb_user="_TIDB_READONLY_USER",
        tidb_password="_TIDB_PASSWORD",
        hdfs_namenode="hdfs://_HADOOP_NAMENODE:8020",
        hdfs_user="_HADOOP_USER",
        remote_config_url="https://config-server.internal.-domain.com",
        artifact_repo_url="s3://_MODEL_BUCKET/mot/production"
    )
